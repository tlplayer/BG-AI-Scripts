...
IF ~~ THEN BEGIN BPEA_BENTLY_PITS
  ...
  IF ~~ THEN REPLY ~Send us to the Black Pits.~ DO ~SetGlobal("BLACK_PITS","GLOBAL",1) SetGlobal("BPEA_OPENING_SKIPPED","GLOBAL",1) SetGlobal("BPEA_START_AT_FIVE","GLOBAL",1) SetGlobal("BPBAELOT_DIALOG","GLOBAL",11) SetGlobal("BPINTRO","GLOBAL",1) SetGlobal("LAST_BATTLE","GLOBAL",102) SetGlobal("TIER","GLOBAL",1) SetGlobal("BATTLE_COMPLETE","GLOBAL",1) SetGlobal("START_BATTLE","GLOBAL",0) SetGlobal("T0_B1","GLOBAL",-1) SetGlobal("T0_B2","GLOBAL",-1) SetGlobal("T1_B1","GLOBAL",-1) SetGlobal("T1_B2","GLOBAL",-1) SetGlobal("T1_B3","GLOBAL",0) ActionOverride(Player1,LeaveAreaLUA("OH9360","LEAVEA",[742.520],6)) ActionOverride(Player2,LeaveAreaLUA("OH9360","LEAVEA",[760.520],6)) ActionOverride(Player3,LeaveAreaLUA("OH9360","LEAVEA",[724.520],6)) ActionOverride(Player4,LeaveAreaLUA("OH9360","LEAVEA",[742.548],6)) ActionOverride(Player5,LeaveAreaLUA("OH9360","LEAVEA",[760.548],6)) ActionOverride(Player6,LeaveAreaLUA("OH9360","LEAVEA",[724.548],6))~ EXIT
